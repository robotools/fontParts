...
class DeprecatedPoint(DeprecatedBase, DeprecatedTransformation):
    def _generateIdentifier(self):
        warnings.warn(
            "'Point._generateIdentifier()': use 'Point._getIdentifier()'",
            DeprecationWarning,
        )
    ...
    def generateIdentifier(self):
        warnings.warn(
            "'Point.generateIdentifier()': use 'Point.getIdentifier()'",
            DeprecationWarning,
        )
        return self.getIdentifier()

    def getParent(self):
        warnings.warn("'Point.getParent()': use 'Point.contour'", DeprecationWarning)
        return self.contour
...
class DeprecatedBPoint(DeprecatedBase, DeprecatedTransformation):
    def _generateIdentifier(self):
        warnings.warn(
            "'BPoint._generateIdentifier()': use 'BPoint._getIdentifier()'",
            DeprecationWarning,
        )
        return self._getIdentifier()
    ...
    def generateIdentifier(self):
        warnings.warn(
            "'BPoint.generateIdentifier()': use 'BPoint.getIdentifier()'",
            DeprecationWarning,
        )
        return self.getIdentifier()

    def getParent(self):
        warnings.warn("'BPoint.getParent()': use 'BPoint.contour'", DeprecationWarning)
        return self.contour
...
class DeprecatedAnchor(DeprecatedBase, DeprecatedTransformation):
    def _generateIdentifier(self):
        warnings.warn(
            "'Anchor._generateIdentifier()': use 'Anchor._getIdentifier()'",
            DeprecationWarning,
        )
        return self._getIdentifier()
    ...
    def generateIdentifier(self):
        warnings.warn(
            "'Anchor.generateIdentifier()': use 'Anchor.getIdentifier()'",
            DeprecationWarning,
        )
        return self.getIdentifier()

    def getParent(self):
        warnings.warn("'Anchor.getParent()': use 'Anchor.glyph'", DeprecationWarning)
        return self.glyph
...
class DeprecatedComponent(DeprecatedBase):
    ...
    def getParent(self):
        warnings.warn(
            "'Component.getParent()': use 'Component.glyph'", DeprecationWarning
        )
        return self.glyph

    def move(self, *args, **kwargs):
        warnings.warn("'Component.move()': use Component.moveBy()", DeprecationWarning)
        self.moveBy(*args, **kwargs)

    def translate(self, *args, **kwargs):
        warnings.warn(
            "'Component.translate()': use Component.moveBy()", DeprecationWarning
        )
        self.moveBy(*args, **kwargs)

    def rotate(self, *args, **kwargs):
        warnings.warn(
            "'Component.rotate()': use Component.rotateBy()", DeprecationWarning
        )
        if "offset" in kwargs:
            kwargs["origin"] = kwargs["offset"]
            del kwargs["offset"]
    ...
    def transform(self, *args, **kwargs):
        warnings.warn(
            "'Component.transform()': use Component.transformBy()", DeprecationWarning
        )
        self.transformBy(*args, **kwargs)

    def skew(self, *args, **kwargs):
        warnings.warn("'Component.skew()': use Component.skewBy()", DeprecationWarning)
        if "offset" in kwargs:
            kwargs["origin"] = kwargs["offset"]
            del kwargs["offset"]
        self.skewBy(*args, **kwargs)
...
class DeprecatedSegment(DeprecatedBase, DeprecatedTransformation):
    def getParent(self):
        warnings.warn(
            "'Segment.getParent()': use 'Segment.contour'", DeprecationWarning
        )
        return self.contour
...
class DeprecatedContour(DeprecatedBase, DeprecatedTransformation):
    ...
    def reverseContour(self):
        warnings.warn(
            "'Contour.reverseContour()': use 'Contour.reverse()'", DeprecationWarning
        )
        self.reverse()

    def _generateIdentifier(self):
        warnings.warn(
            "'Contour._generateIdentifier()': use 'Contour._getIdentifier()'",
            DeprecationWarning,
        )
        return self._getIdentifier()
    ...
    def generateIdentifier(self):
        warnings.warn(
            "'Contour.generateIdentifier()': use 'Contour.getIdentifier()'",
            DeprecationWarning,
        )
        return self.getIdentifier()
    ...
    def _generateIdentifierforPoint(self, point):
        warnings.warn(
            (
                "'Contour._generateIdentifierforPoint()': use "
                "'Contour._getIdentifierforPoint()'"
            ),
            DeprecationWarning,
        )
    ...
    def generateIdentifierforPoint(self, point):
        warnings.warn(
            (
                "'Contour.generateIdentifierforPoint()': use "
                "'Contour.getIdentifierForPoint()'"
            ),
            DeprecationWarning,
        )
...
class DeprecatedGlyph(DeprecatedBase, DeprecatedTransformation):
    ...
    def getComponents(self):
        warnings.warn(
            "'Glyph.getComponents()': use Glyph.components", DeprecationWarning
        )
        return self.components

    def getParent(self):
        warnings.warn("'Glyph.getParent()': use 'Glyph.font'", DeprecationWarning)
        return self.font
...
class DeprecatedGroups(object):
    ...
    def setChanged(self):
        warnings.warn("'Groups.setChanged': use Groups.changed()", DeprecationWarning)
        self.changed()
...
class RemovedKerning(object):
    ...
    @staticmethod
    def eliminate(
        leftGlyphsToEliminate=None, rightGlyphsToEliminate=None, analyzeOnly=False
    ):
    ...
    @staticmethod
    def implodeClasses(leftClassDict=None, rightClassDict=None, analyzeOnly=False):
        raise RemovedError("Kerning.implodeClasses()")

    @staticmethod
    def explodeClasses(leftClassDict=None, rightClassDict=None, analyzeOnly=False):
...
class DeprecatedKerning(object):
    ...
    def getParent(self):
        warnings.warn("'Kerning.getParent()': use 'Kerning.font'", DeprecationWarning)
        return self.font
...
class DeprecatedInfo(DeprecatedBase):
    def getParent(self):
        warnings.warn("'Info.getParent()': use 'Info.font'", DeprecationWarning)
        return self.font
...
class DeprecatedImage(DeprecatedBase):
    def getParent(self):
        warnings.warn("'Image.getParent()': use 'Image.glyph'", DeprecationWarning)
        return self.glyph
...
class DeprecatedFeatures(DeprecatedBase):
    def getParent(self):
        warnings.warn("'Features.getParent()': use 'Features.font'", DeprecationWarning)
        return self.font
...
class DeprecatedLayer(DeprecatedBase):
    def getParent(self):
        warnings.warn("'Layer.getParent()': use 'Layer.font'", DeprecationWarning)
        return self.font
...
class DeprecatedFont(DeprecatedBase):
    def _get_fileName(self):
        warnings.warn(
            "'Font.fileName': use os.path.basename(Font.path)", DeprecationWarning
        )
        return self.path
    ...
    def getWidth(self, glyphName):
        warnings.warn(
            "'Font.getWidth(): use Font[glyphName].width'", DeprecationWarning
        )
    ...
    def _get_selection(self):
        warnings.warn(
            "'Font.selection: use Font.selectedGlyphNames'", DeprecationWarning
        )
    ...
    selection = property(
        _get_selection, _set_selection, doc="Deprecated Font.selection"
    )
