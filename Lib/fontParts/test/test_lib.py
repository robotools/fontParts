...
class TestLib(unittest.TestCase):
    ...
    def test_get_parent_glyph(self):
        ...
        self.assertEqual(lib.glyph, glyph)
    ...
    def test_get_parent_font(self):
        ...
        self.assertEqual(lib.font, font)
    ...
    def test_keys(self):
        lib = self.getLib_generic()
        self.assertEqual(sorted(lib.keys()), ["key 1", "key 2", "key 3", "key 4"])
    ...
    def test_get_found(self):
        lib = self.getLib_generic()
        self.assertEqual(lib["key 1"], ["A", "B", "C"])
    ...
    def test_hash(self):
        lib = self.getLib_generic()
        self.assertEqual(isinstance(lib, collections.abc.Hashable), True)
    ...
    def test_object_equal_self(self):
        ...
        self.assertEqual(lib_one, lib_one)

    def test_object_not_equal_other(self):
        lib_one = self.getLib_generic()
        lib_two = self.getLib_generic()
        self.assertNotEqual(lib_one, lib_two)

    def test_object_equal_self_variable_assignment(self):
        lib_one = self.getLib_generic()
        a = lib_one
        self.assertEqual(lib_one, a)

    def test_object_not_equal_other_variable_assignment(self):
        lib_one = self.getLib_generic()
        lib_two = self.getLib_generic()
        a = lib_one
        self.assertNotEqual(lib_two, a)
